...
#BONUS1:this line formats text and remove special characters and white spaces,also it changes all the text into lower spaces.
#BONUS2: other than dict,you can also do the program using list.
